package com.marathon.ktm.model.converter
...
class VenueTypeConverter : JsonDeserializer<VenueWrapper> {
    ...
    private fun validateResponse(json: JsonObject?): Boolean {
        return json != null && json.asJsonObject.getAsJsonObject("meta")
            .getAsJsonPrimitive("code").asString == "200"
    }
    ...
    private fun getVenue(rawVenue: JsonObject): Venue {
        ...
        val iconURL =
            categories.getAsJsonObject("icon").getAsJsonPrimitive("prefix").asString + "64.png"
